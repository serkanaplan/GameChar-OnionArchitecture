...
public class GetAllCharactersQueryHandler(ICharacterReadRepository characterRepository) : IRequestHandler<GetAllCharactersQuery, Pagination<CharacterDto>>
{
    private readonly ICharacterReadRepository _characterRepository = characterRepository;

    public async Task<Pagination<CharacterDto>> Handle(GetAllCharactersQuery request, CancellationToken cancellationToken)
    {
